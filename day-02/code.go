...
// 2. Bitta parametrli funksiya
func greetPerson(name string) {
	fmt.Printf("Salom, %s!\n", name)
}

// 3. Ko'p parametrli funksiya
func printInfo(name string, age int, city string) {
	fmt.Printf("Ism: %s, Yosh: %d, Shahar: %s\n", name, age, city)
}

// 4. Qaytarish qiymatli funksiya - bitta natija
func add(a, b int) int {
	return a + b
}

// 5. Qisqa sintaksis - parametrlar bir xil tip bo'lsa
func multiply(a, b int) int {
	return a * b
}

// 6. Float qaytarish qiymati
func divide(a, b float64) float64 {
	return a / b
}

// 7. Ko'p qaytarish qiymati - ikkita natija
...
// 8. To'rtburchak perimetri va yuzasi
...
// 9. Nomlangan qaytarish qiymatlar - avtomatik return
...
// 10. Nomlangan qaytarish qiymatlar - ko'paytma va bo'linma
...
// 11. Variadic funksiya - cheksiz parametr
...
// 12. Variadic funksiya - matnlar bilan
...
// 13. Funksiya ichida funksiya chaqirish
...
// 15. Funksiya tipi - funksiyani parametr sifatida uzatish
...
// 16. Amaliy misol - ism birlashtirish
func combineNames(firstName, lastName string) string {
	return firstName + " " + lastName
}

// 17. Amaliy misol - yosh hisoblash
func calculateAge(birthYear int) int {
	currentYear := 2024
	return currentYear - birthYear
}

// 18. Amaliy misol - doira yuzasi va perimetri
...
// 19. Amaliy misol - uchburchak yuzasi (Geron formulasi)
func triangleArea(a, b, c float64) float64 {
	p := (a + b + c) / 2
	return p * (p - a) * (p - b) * (p - c)
}

// 20. Amaliy misol - email tekshirish
func validateEmail(email string) bool {
	return strings.Contains(email, "@") && strings.Contains(email, ".")
}

// 21. Amaliy misol - matnni formatlash
